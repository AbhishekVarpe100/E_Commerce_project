...
function handleUpdate(e) {
  ...
  axios.post(`http://localhost:3000/updatecosmetics/${id}`, formData)
      .then(res => {
          if (res.data === 'success') {
              ...
              setTimeout(() => {
                  ...
                  setTimeout(() => {
                    navigate('/admin/available/cosmetics')
                  }, 1000);
  ...
  return (
    <div>
      ...
      <Link to='/admin/available/cosmetics' className='btn btn-warning m-4 w-25'>&#8592; Back</Link>
      <center>
        {success}
        {failure}
