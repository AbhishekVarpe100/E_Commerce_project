...
function handleUpdate(e) {
  ...
  axios.post(`http://localhost:3000/updatefood/${id}`, formData)
      .then(res => {
          if (res.data === 'success') {
  ...
  return (
    <div>
      <Link to='/admin/available/food' className='btn btn-warning m-4 w-25'>&#8592; Back</Link>
      <center>
        {success}
        {failure}
